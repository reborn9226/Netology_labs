# Домашнее задание к занятию «Система мониторинга Zabbix. Часть 2» Ершов А.О.
...
- [ ] Прикрепите в файл README.md скриншот страницы шаблона с названием «Задание 1»
 ...
 ---
 ### Решение  1
 - Созданный шаблон с моей фамилией
![](.scrin/template.png)

- Создал два Item CPU%, RAM%
![](.scrin/item_cpu_ram.png)
...
- [ ] Прикрепите в файл README.md скриншот страницы хостов, где будут видны привязки шаблонов с названиями «Задание 2-3». Хосты должны иметь зелёный статус подключения
 ...
 ---
### Решение 3
- У меня два хоста Agent и Zabbix server в котором включен zabbix agent
![](.scrin/host_template.png)
...
- [ ] Прикрепите в файл README.md скриншот дашборда с названием «Задание 4»
 ...
 ---
### Решение 4
- Собрал Dashboard для win11 agent
![](.scrin/dashboard.png)
